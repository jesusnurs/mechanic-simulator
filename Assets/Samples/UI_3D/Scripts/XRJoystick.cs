...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRJoystick : XRBaseInteractable
    {
        ...
        public UnityEvent OnValueChange { get; private set; } = new UnityEvent();
        ...
        private void StartGrab(SelectEnterEventArgs args)
        {
            ...
            if (useOffset)
            {
                offset = m_Handle.InverseTransformPoint(m_Interactor.GetAttachTransform(this).position);
                offset.y = 0;
            }
        }
        ...
        {  
            Vector3 direction = m_Interactor.GetAttachTransform(this).position - m_Handle.TransformPoint(offset);
