...
{
    public sealed class RemovableWheelInteractable : MonoBehaviour, IPlayerInteractable, IPlayerFocusVisibility
    {
        ...
        public string InteractionPrompt => Action != null ? Action.InteractionPrompt : "ЛКМ - снять колесо";
